...
public class NeoDatisError implements IError {
	...
	public static final NeoDatisError INSTANCE_POSITION_OUT_OF_FILE = new NeoDatisError(101, "ODB is trying to read an instance at position @1 which is out of the file - File size is @2");
	public static final NeoDatisError INSTANCE_POSITION_IS_NEGATIVE = new NeoDatisError(102, "ODB is trying to read an instance at a negative position @1 , oid=@2 : @3");
	public static final NeoDatisError WRONG_TYPE_FOR_BLOCK_TYPE = new NeoDatisError(201, "Block type of wrong type : expected @1, Found @2 at position @3");
	...
	public static final NeoDatisError WRONG_OID_AT_POSITION = new NeoDatisError(203, "Reading object with oid @1 at position @2, but found oid @3");
	...
	public static final NeoDatisError OBJECT_IS_MARKED_AS_DELETED_FOR_OID = new NeoDatisError(206, "Object with oid @1 is marked as deleted");
	public static final NeoDatisError OBJECT_IS_MARKED_AS_DELETED_FOR_POSITION = new NeoDatisError(207, "Object with position @1 is marked as deleted");
	public static final NeoDatisError NATIVE_TYPE_NOT_SUPPORTED = new NeoDatisError(208, "Native type not supported @1 @2");
	public static final NeoDatisError NATIVE_TYPE_DIVERGENCE = new NeoDatisError(209, "Native type informed(@1) is different from the one informed (@2)");
	public static final NeoDatisError NEGATIVE_CLASS_NUMBER_IN_HEADER = new NeoDatisError(210, "number of classes is negative while reading database header : @1 at position @2");
	...
	public static final NeoDatisError OBJECT_WITH_OID_DOES_NOT_EXIST_IN_CACHE = new NeoDatisError(213, "Object with oid @1 does not exist in cache");
	public static final NeoDatisError OBJECT_INFO_NOT_IN_TEMP_CACHE = new NeoDatisError(214, "ObjectInfo does not exist in temporary cache oid=@1 and position=@2");
	...
	public static final NeoDatisError ERROR_IN_CORE_PROVIDER_INITIALIZATION = new NeoDatisError(217, "Error while initializing CoreProvider @1");
	public static final NeoDatisError UNDEFINED_CLASS_INFO = new NeoDatisError(218, "Undefined class info for @1");
	public static final NeoDatisError ABSTRACT_OBJECT_INFO_TYPE_NOT_SUPPORTED = new NeoDatisError(219, "Abstract Object Info type not supported : @1");
	...
	public static final NeoDatisError INSTANCE_BUILDER_WRONG_OBJECT_TYPE = new NeoDatisError(223, "Wrong type of object: expecting @1 and received @2");
	public static final NeoDatisError INSTANCE_BUILDER_WRONG_OBJECT_CONTAINER_TYPE = new NeoDatisError(224, "Building instance of @1 : can not put a @2 into a @3 in field @4");
	public static final NeoDatisError INSTANCE_BUILDER_NATIVE_TYPE_IN_COLLECTION_NOT_SUPPORTED = new NeoDatisError(225, "Native @1 in Collection(List,array,Map) not supported");
	public static final NeoDatisError OBJECT_INTROSPECTOR_NO_FIELD_WITH_NAME = new NeoDatisError(226, "Class/Interface @1 does not have attribute '@2'");
	...
	public static final NeoDatisError BUFFER_TOO_SMALL = new NeoDatisError(229, "Buffer too small: buffer size = @1 and data size = @2 - should not happen");
	public static final NeoDatisError FILE_INTERFACE_WRITE_BYTES_NOT_IMPLEMENTED_FOR_TRANSACTION = new NeoDatisError(230, "writeBytes not implemented for transactions");
	public static final NeoDatisError FILE_INTERFACE_READ_ERROR = new NeoDatisError(231, "Error reading @1 bytes at @2 : read @3 bytes instead");
	public static final NeoDatisError POINTER_TO_SELF = new NeoDatisError(232, "Error while creating a pointer : a pointer to itself : @1 -> @2 for oid @3");
	...
	public static final NeoDatisError META_MODEL_CLASS_WITH_OID_DOES_NOT_EXIST = new NeoDatisError(236, "Class with oid @1 does not exist in meta-model");
	public static final NeoDatisError META_MODEL_CLASS_WITH_POSITION_DOES_NOT_EXIST = new NeoDatisError(237, "Class with position @1 does not exist in meta-model");
	public static final NeoDatisError CLASS_INFO_DO_NOT_HAVE_THE_ATTRIBUTE = new NeoDatisError(238, "Class @1 does not have attribute with name @2 in the database meta-model");
	public static final NeoDatisError ODB_TYPE_ID_DOES_NOT_EXIST = new NeoDatisError(239, "ODBtype with id @1 does not exist");
	public static final NeoDatisError ODB_TYPE_NATIVE_TYPE_WITH_ID_DOES_NOT_EXIST = new NeoDatisError(240, "Native type with id @1 does not exist");
	...
	public static final NeoDatisError CRYPTO_ALGORITH_NOT_FOUND = new NeoDatisError(243, "Could not get the MD5 algorithm to encrypt the password");
	...
	public static final NeoDatisError SERIALIZATION_FROM_STRING = new NeoDatisError(247, "Error while deserializing: expecting classId @1 and received @2");
	public static final NeoDatisError SERIALIZATION_COLLECTION = new NeoDatisError(248, "Error while deserializing collection: sizes are not consistent : expected @1, found @2");
	public static final NeoDatisError METAMODEL_READING_LAST_OBJECT = new NeoDatisError(249, "Error while reading last object of type @1 at with OID @2");
	public static final NeoDatisError CACHE_NEGATIVE_OID = new NeoDatisError(250, "Negative oid set in cache @1");
	public static final NeoDatisError CLIENT_SERVER_SYNCHRONIZE_IDS = new NeoDatisError(251, "Error while synchronizing oids,length are <>, local=@1, client=@2");
	public static final NeoDatisError CLIENT_SERVER_CAN_NOT_OPEN_ODB_SERVER_ON_PORT = new NeoDatisError(252, "Can not start ODB server on port @1");
	public static final NeoDatisError CLIENT_SERVER_CAN_NOT_ASSOCIATE_OIDS = new NeoDatisError(253, "Can not associate server and client oids : server oid=@1 and client oid=@2");
	public static final NeoDatisError SESSION_DOES_NOT_EXIST_FOR_CONNECTION = new NeoDatisError(254, "Connection @1 for base @2 does not have any associated session");
	public static final NeoDatisError SESSION_DOES_NOT_EXIST_FOR_CONNECTION_ID = new NeoDatisError(255, "Connection ID @1 does not have any associated session");
	public static final NeoDatisError CLIENT_SERVER_ERROR = new NeoDatisError(256, "ServerSide Error : @1");
	public static final NeoDatisError OBJECT_READER_DIRECT_CALL = new NeoDatisError(257, "Generic readObjectInfo called for non native object info");
	public static final NeoDatisError CACHE_OBJECT_INFO_HEADER_WITHOUT_CLASS_ID = new NeoDatisError(258, "Object Info Header without class id ; oih.oid=@1");
	public static final NeoDatisError NON_NATIVE_ATTRIBUTE_STORED_BY_POSITION_INSTEAD_OF_OID = new NeoDatisError(259, "Non native attribute (@1) of class @2 stored by position @3 instead of oid");
	...
	public static final NeoDatisError CLIENT_SERVER_CAN_NOT_CREATE_CLASS_INFO = new NeoDatisError(264, "ServerSide Error : Can not create class info @1");
	...
	public static final NeoDatisError CACHE_NEGATIVE_POSITION = new NeoDatisError(268, "Caching an ObjectInfoHeader with negative position @1");
	public static final NeoDatisError ERROR_WHILE_GETTING_OBJECT_FROM_LIST_AT_INDEX = new NeoDatisError(269, "Error while getting object from list at index @1");
	public static final NeoDatisError CLASS_INFO_DOES_NOT_EXIST_IN_META_MODEL = new NeoDatisError(270, "Class Info @1 does not exist in MetaModel");
	...
	public static final NeoDatisError CLIENT_SERVER_UNKNOWN_SESSION = new NeoDatisError(272, "The session with id @1 does not exist for base @2");
	...
	public static final NeoDatisError INSTANCE_BUILDER_NATIVE_TYPE = new NeoDatisError(274, "Native object of type @1 can not be instanciated");
	...
	public static final IError COLLECTION_INSTANCIATION_ERROR = new NeoDatisError(278, "Error while creating instance of Collection of class @1");
	...
	public static final NeoDatisError REFLECTION_ERROR_WHILE_GETTING_FIELD = new NeoDatisError(289, "Error while getting field @1 on class @2");
	...
	public static final NeoDatisError INDEX_IS_CORRUPTED = new NeoDatisError(292, "Index '@1' of class '@2' is corrupted: class has @3 objects, index has @4 entries, try to rebuild the index");
	public static final NeoDatisError ERROR_WHILE_CREATING_MESSAGE_STREAMER = new NeoDatisError(293, "Error while creating message streamer '@1'");
	...
	public static final NeoDatisError LAZY_MODE_WITH_DISCONNECTED_SESSION = new NeoDatisError(299, "Lazy object fetching has been configured but NeoDatis session has been closed");

	// *********************************************
	// User errors
	// *********************************************
	public static final NeoDatisError CRITERIA_QUERY_UNKNOWN_ATTRIBUTE = new NeoDatisError(1000, "Attribute '@1' used in criteria queria does not exist on class '@2'");
	public static final NeoDatisError RUNTIME_INCOMPATIBLE_VERSION = new NeoDatisError(1001, "Incompatible ODB Version : ODB file version is @1 and Runtime version is @2");
	public static final NeoDatisError INCOMPATIBLE_METAMODEL = new NeoDatisError(1002, "Incompatible meta-model : @1");
	public static final NeoDatisError INCOMPATIBLE_JAVA_VM = new NeoDatisError(1003, "Incompatible java virtual Machine, 1.5 or greater is required, you are using : @1");
	public static final NeoDatisError ODB_IS_CLOSED = new NeoDatisError(1004, "ODB session has already been closed (session-id=@1)");
	...
	public static final NeoDatisError ODB_CAN_NOT_RETURN_OID_OF_NULL_OBJECT = new NeoDatisError(1012, "Can not return the oid of a null object");
	public static final NeoDatisError ODB_FILE_IS_LOCKED_BY_CURRENT_VIRTUAL_MACHINE = new NeoDatisError(1013,
	...
	public static final NeoDatisError USER_NAME_TOO_LONG = new NeoDatisError(1015, "User name @1 is too long, should be lesser than 20 characters");
	public static final NeoDatisError PASSWORD_TOO_LONG = new NeoDatisError(1016, "Password is too long, it must be less than 20 character long");
	public static final NeoDatisError TRANSACTION_ALREADY_COMMITED_OR_ROLLBACKED = new NeoDatisError(1017, "Transaction have already been 'committed' or 'rollbacked'");
	public static final NeoDatisError DIFFERENT_SIZE_IN_WRITE_ACTION = new NeoDatisError(1018, "Size difference in WriteAction.persist :(calculated,stored)=(@1,@2)");
	public static final NeoDatisError CLASS_WITHOUT_CONSTRUCTOR = new NeoDatisError(1019, "Class without any constructor : @1");
	public static final NeoDatisError NO_NULLABLE_CONSTRUCTOR = new NeoDatisError(1020,
	...
	public static final NeoDatisError QUERY_BAD_CRITERIA = new NeoDatisError(1021, "CollectionSizeCriteria only work with Collection or Array, and you passed a @1 instead");
	public static final NeoDatisError QUERY_COLLECTION_SIZE_CRITERIA_NOT_SUPPORTED = new NeoDatisError(1022, "CollectionSizeCriterion sizeType @1 not yet implemented");
	...
	public static final NeoDatisError QUERY_CONTAINS_CRITERION_TYPE_NOT_SUPPORTED = new NeoDatisError(1025, "Where.contain can not be used with a @1, only collections and arrays are supported");
	...
	public static final NeoDatisError QUERY_NQ_EXCEPTION_RAISED_BY_NATIVE_QUERY_EXECUTION = new NeoDatisError(1030, "Exception raised by the native query @1 match method");
	public static final NeoDatisError ODB_CAN_NOT_RETURN_OID_OF_UNKNOWN_OBJECT = new NeoDatisError(1031, "Can not return the oid of a not previously loaded object : @1");
	public static final NeoDatisError ERROR_WHILE_ADDING_OBJECT_TO_HASHMAP = new NeoDatisError(1032, "Internal error in user object of class @1 in equals or hashCode method : @2");
	public static final NeoDatisError ATTRIBUTE_REFERENCES_A_DELETED_OBJECT = new NeoDatisError(1033, "Object of type @1 with oid @2 has the attribute '@3' that references a deleted object");
	...
	public static final NeoDatisError VALUES_QUERY_ALIAS_DOES_NOT_EXIST = new NeoDatisError(1044, "Alias @1 does not exist in query result. Existing alias are @2");
	public static final NeoDatisError VALUES_QUERY_NOT_CONSISTENT = new NeoDatisError(1045, "Single row actions (like sum,count,min,max) are declared together with multi row actions : @1");
	public static final NeoDatisError VALUES_QUERY_ERROR_WHILE_CLONING_CUSTUM_QFA = new NeoDatisError(1046, "Error while cloning Query Field Action @1");
	public static final NeoDatisError EXECUTION_PLAN_IS_NULL_QUERY_HAS_NOT_BEEN_EXECUTED = new NeoDatisError(1047, "The query has not been executed yet so there is no execution plan available");
	public static final NeoDatisError OBJECT_WITH_OID_DOES_NOT_EXIST = new NeoDatisError(1048, "Object with OID @1 does not exist in the database");
	...
	public static final NeoDatisError UNREGISTERED_BASE_ON_SERVER = new NeoDatisError(1051, "Base @1 must be added on server before configuring it");
	public static final IError UNSUPPORTED_ENCODING = new NeoDatisError(1052, "Unsupported encoding @1");;
	public static final IError RECONNECT_ONLY_WITH_BYTE_CODE_AGENT_CONFIGURED = new NeoDatisError(1053, "Reconnect object only available when Byte code instrumentation is on");
	public static final IError RECONNECT_ONLY_FOR_PREVIOUSLY_LOADED_OBJECT = new NeoDatisError(1054, "Reconnect object only available for objets previously loaded in an ODB Session");
	...
	public static final IError CAN_NOT_ASSOCIATE_SERVER_TRIGGER_TO_LOCAL_OR_CLIENT_ODB = new NeoDatisError(1057, "Can not associate server trigger @1 to local or client ODB");
	public static final IError TRIGGER_CALLED_ON_NULL_OBJECT = new NeoDatisError(1058, "Trigger has been called on class @1 on a null object so it cannot retrieve the value of the '@2' attribute");
	...
	public static final NeoDatisError CAN_NOT_DELETE_NULL_OBJECT = new NeoDatisError(1061, "NeoDatis can not delete null object");
	...
	public static final NeoDatisError EQUAL_CRITERIA_ON_OBJECT_WITH_WRONG_ATTRIBUTE_TYPE = new NeoDatisError(1063,
			"A where.equal (@1) has been created on an object, but the attribute '@2' seems to be a @3, Exception is\n@4");

	public static final NeoDatisError VALUES_QUERY_MUST_USE_GET_VALUES = new NeoDatisError(1064, "Values queries must be executed with getValues and not getObjects");
	...
	public static final IError NET_CLIENT_CONNECTION_IS_DEAD_ = new NeoDatisError(1068, "Client connection has been closed abnormally");
	public static final IError DELETE_OBJECT_NOT_LOADED_OR_CONNECTED = new NeoDatisError(1069, "Can not delete an object that has not been loaded from NeoDatis");
	public static final IError LIKE_WITH_NULL_VALUE = new NeoDatisError(1070, "Can not use Like with null value");

	// NeoDatis Error
	public static final NeoDatisError LAYER3_ATTRIBUTE_HEADER_SIZE_ERROR_WHILE_WRITING = new NeoDatisError(10001,
			"Error while writing attributes header of a NonNative Object with oid @1: calculated size was @2 and real size is @3 : type = @4");
	public static final NeoDatisError LAYER3_ATTRIBUTE_HEADER_SIZE_ERROR_WHILE_READING = new NeoDatisError(10002, "Error while reading attributes header : declared size=@1, real size is @2");
	public static final NeoDatisError LAYER3_UNKNOWN_ATTRIBUTE_TYPE = new NeoDatisError(10003, "Unknown attribute type : should be native or non native and is @1");
	public static final NeoDatisError LAYER3_OID_DOES_OT_MATCH = new NeoDatisError(10004, "OID does not match, should have read @1 but read @2 at offset @3, container object oid is @4 and field is @5.@6, ");
	public static final NeoDatisError LAYER3_BUFFER_OVER_FLOW = new NeoDatisError(10005, "Buffer over flow : buffer size is @1 and requested position is @2");
	public static final NeoDatisError LAYER3_CRC_DOES_OT_MATCH = new NeoDatisError(10006, "CRC does not match for reading data for OID @1, stored crc is @2 and computed crc is @3");
	// User errors
	public static final NeoDatisError LAYER4_DIFFERENT_STORAGE_ENGINE = new NeoDatisError(100001, "Wrong storage engine : Storage engine of database is @1 and storage engine configured is @2");
	public static final IError LAYER4_UNDEFINED = new NeoDatisError(100002, "No storage engine defined");;
