...
*/
package org.neodatis.odb.core.query.list.values;
...
public class InMemoryBTreeCollectionForValues extends AbstractBTreeCollection<ObjectValues> implements Values {
    ...
    public InMemoryBTreeCollectionForValues(int size,int btreeDegree) {
        super(size, OrderByConstants.ORDER_BY_ASC,btreeDegree);
    }

    public InMemoryBTreeCollectionForValues(int size, OrderByConstants orderByType,int btreeDegree) {
