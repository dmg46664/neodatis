...
public class ConnectionAction {
	...
	public static final int ACTION_INSERT_OR_UPDATE = 100;
	public static final String ACTION_INSERT_OR_UPDATE_LABEL = "insert or update";

	protected static final String[] ACTION_LABELS = {ACTION_CONNECT_LABEL,ACTION_INSERT_LABEL,ACTION_UPDATE_LABEL,ACTION_DELETE_LABEL,ACTION_SELECT_LABEL, ACTION_COMMIT_LABEL,ACTION_CLOSE_LABEL,ACTION_ROLLBACK_LABEL, ACTION_INSERT_OR_UPDATE_LABEL};
