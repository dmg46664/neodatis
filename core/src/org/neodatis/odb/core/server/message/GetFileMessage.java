...
public class GetFileMessage extends Message {
	...
	public GetFileMessage(boolean getFileInServerInbox, String remoteFileName, boolean putFileInClientInbox, String localFileName){
		super(MessageType.GET_FILE, null,null);
	...
	public GetFileMessage(String baseId, String sessionId,boolean getFileInServerInbox, String remoteFileName, boolean putFileInClientInbox, String localFileName){
		super(MessageType.GET_FILE, baseId,sessionId);
		this.localFileName = localFileName;
		this.remoteFileName = remoteFileName;
		this.getFileInServerInbox = getFileInServerInbox;
		this.putFileInClientInbox = putFileInClientInbox;
	...
	public GetFileMessage(String baseId, String sessionId,String remoteFileName){
		super(MessageType.GET_FILE, baseId,sessionId);
		this.localFileName = remoteFileName;
		this.remoteFileName = remoteFileName;
		this.getFileInServerInbox = true;
		this.putFileInClientInbox = true;
	}
