...
public interface ClassIntrospector{
	 ...
	 */
	public abstract ClassInfoList introspect(Class clazz);
	...
	public abstract IOdbList<Field> removeUnnecessaryFields(IOdbList<Field> fields);

	public abstract ClassInfoList introspect(String fullClassName);
