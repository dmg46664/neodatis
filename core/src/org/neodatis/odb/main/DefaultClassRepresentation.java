...
public class DefaultClassRepresentation implements ClassRepresentation{
	...
	public DefaultClassRepresentation(SessionEngine storageEngine, ClassInfo classInfo) {
		super();
		this.storageEngine = storageEngine;
		this.classInfo = classInfo;
		this.classIntrospector = storageEngine.getObjectIntrospector().getClassIntrospector();
	}
