...
public class CriteriaQueryManager {
    public boolean match(CriteriaQuery query, Map map) {
        return query.match(map);
    }

	public boolean match(CriteriaQuery query, Object object) {
        return query.match((AbstractObjectInfo) object);
    }
    
    public String getFullClassName(CriteriaQuery query){
