...
public class SessionImpl implements Session {
	...
	private void writeNewDatabaseHeader() {
		...
		DatabaseInfo di = new DatabaseInfo(this.databaseId, false, null, 200, getConfig().getDatabaseCharacterEncoding(), getOidGenerator().getClass().getName() );

		engine.writeDatabaseHeader(di);
	}
