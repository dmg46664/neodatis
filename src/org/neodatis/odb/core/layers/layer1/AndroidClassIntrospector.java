 ...
 * 
 */
public class AndroidClassIntrospector extends ClassIntrospectorImpl {
	
	public AndroidClassIntrospector(Session session, OidGenerator oidGenerator) {
	 ...
	 * @return
	 */
	public boolean tryToCreateAnEmptyConstructor(Class clazz) {
		return false;
	}
}
