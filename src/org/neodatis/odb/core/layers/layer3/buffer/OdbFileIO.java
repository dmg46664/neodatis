...
public class OdbFileIO implements IO{
	...
	public void init(String fileName, boolean canWrite, String password) throws IOException{
		...
		try{
			...
			throw new NeoDatisRuntimeException(e, "Error while opening file " + fileName);
		}
	...
	public void seek(long position) throws IOException {
		try {
			...
			throw new NeoDatisRuntimeException(NeoDatisError.GO_TO_POSITION.addParameter(position).addParameter(fileAccess.length()), e);
		}
	}
