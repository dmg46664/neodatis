...
public class CollectionSizeCriterion extends AbstractCriterion {
	...
	public boolean match(Object valueToMatch) {
		...
		throw new NeoDatisRuntimeException(NeoDatisError.QUERY_BAD_CRITERIA.addParameter(valueToMatch.getClass().getName()));
	}
	private boolean matchSize(int collectionSize, int requestedSize, int sizeType ){
		...
		throw new NeoDatisRuntimeException(NeoDatisError.QUERY_COLLECTION_SIZE_CRITERIA_NOT_SUPPORTED.addParameter(sizeType));
	}
