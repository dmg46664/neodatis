 ...
 *  
 */
final public class LongKeyOpenHashMap<E> extends AbstractLongKeyMap<E> implements LongKeyMap<E>, Cloneable, Serializable {

	private static final long serialVersionUID = -1808772586509084599L;
    ...
    private transient Collection<E> cvalues;
     ...
     */
    public LongKeyOpenHashMap(LongKeyMap<E> map) {
        this();
        putAll(map);
    }
    ...
    public Object clone() {
        try {
            LongKeyOpenHashMap<E> c = (LongKeyOpenHashMap<E>)super.clone();
